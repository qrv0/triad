...
We close by mapping the equation's mathematical form onto six domains where the same structural shape is independently documented: (i) other instances of nonlinear Schrödinger dynamics, particularly in Bose–Einstein condensates and nonlinear optical media; (ii) baryon acoustic oscillations in cosmological structure formation; (iii) Chladni cymatic patterns in vibrated media; (iv) gamma-frequency neural entrainment and amyloid-β clearance; (v) low-frequency acoustic resonances measured at megalithic chambers; and (vi) the Markovian-embedded state representation used in contemporary neural sequence architectures (S4, S5, Mamba, RWKV), where the mathematical correspondence is exact and requires no dimensional calibration. The structural correspondence is exact in form; the dimensional calibration that relates the equation's unit time to specific physical frequencies in domains (iv) and (v) is a choice and we mark it as such. The argument advanced is not that the equation predicts these phenomena under a single privileged identification, but that the same mathematical structure appears at multiple scales of physical and computational organization, and that this is the criterion by which a structural realist evaluates a candidate fundamental form.
...
Acoustic measurements of stone and limestone chambers, conducted in several independent surveys, report low-frequency standing-wave resonances. The Princeton–PEAR survey of six Neolithic and Iron Age chambers in the British Isles reported resonances in the 95–120 Hz band, with most peaks tightly clustered near 110 Hz (Jahn, Devereux & Ibison 1996). Subsequent measurements of the Oracle Room at the Hypogeum of Ħal-Saflieni in Malta report a dual resonance at approximately 70 Hz and 114 Hz (Debertolis, Coimbra & Eneix 2015). The King's Chamber of the Great Pyramid of Giza, despite its very different construction (granite rather than limestone or earth-and-stone) and substantially different cavity dimensions, exhibits low-frequency resonances in the 110–122 Hz range across multiple measurement modalities.

A neurophysiological study using quantitative electroencephalography reports that acoustic tones at 110 Hz, but not at 90, 100, 120, or 130 Hz, produce a statistically significant deactivation of the left temporal lobe and a shift in prefrontal cortex laterality from baseline left to right dominance (Cook, Pajot & Leuchter 2008). The neurological pattern is characteristic of deep meditative and trance-like states.

Within the equation, under a dimensional identification in which the box length corresponds to 20 meters and one unit of computational time corresponds to 9 milliseconds, one cycle per unit time corresponds to approximately 111 Hz. Under this identification, the two-dimensional median dominant frequency of 0.6 cycles per unit time maps to approximately 66 Hz, and the unit-frequency secondary mode maps to 111 Hz. These two values fall within the bands measured at the archaeoacoustic sites, and the 110 Hz value is the one at which the documented EEG signature is observed.

We are explicit about the limits of this mapping. The dimensional identification ($L = 20$ m, $dt = 9$ ms) is a choice. Under different choices the equation produces different absolute frequencies. The structural fact—that the equation has two principal frequency modes in a specific ratio—is dimension-independent. The numerical mapping to 66 Hz and 111 Hz is an instance of that structure under one calibration. The claim we make is not that the equation predicts the megalithic measurements; the claim is that the equation, the archaeoacoustic measurements, and the EEG observation are independently documented instances of the same structural form, and that this co-occurrence is itself the cross-domain coherence test that a structural realist applies.

In the three-dimensional version of the equation, the median dominant frequency in the crystalline window is 0.20 cycles per unit time, which under the same calibration would correspond to 22 Hz rather than 66 Hz. This is a structural rescaling consistent with the dimensional rescaling of the memory coupling discussed in Section 6.1: the absolute frequencies depend on the underlying timescale of the slow memory mode against the spatial dispersion, which changes with dimensionality. The structural relations are preserved; the calibrations are not.
