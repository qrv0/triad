...
- The two-level structure of [`../methodology/02-limits-of-falsification.md`](../methodology/02-limits-of-falsification.md): the global structural claim is evaluated by the six criteria of [`../methodology/04-the-six-criteria.md`](../methodology/04-the-six-criteria.md) and is not subject to single-experiment refutation; specific numerical predictions remain locally falsifiable in the standard sense.
