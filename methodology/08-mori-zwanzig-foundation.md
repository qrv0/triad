...
- Diagonal SSMs (interface 06) as a machine-learning instantiation of the same reduced description
...
- [`../interfaces/18-pseudomode-quantum.md`](../interfaces/18-pseudomode-quantum.md), [`../interfaces/19-viscoelasticity-prony.md`](../interfaces/19-viscoelasticity-prony.md), [`../interfaces/06-state-space-models.md`](../interfaces/06-state-space-models.md), [`../interfaces/21-hawkes-intensity.md`](../interfaces/21-hawkes-intensity.md): substrate-specific instantiations of the MZ auxiliary-mode reduction.
