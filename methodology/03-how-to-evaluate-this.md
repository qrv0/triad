...
If you find that one or two interfaces fail your scrutiny but the others survive, ask whether the surviving ones constitute sufficient structural correspondence to support the claim. If all six fail your scrutiny, the work's structural claim does not survive your evaluation. If all six survive, the work has passed the structural-realist test as it asks to be evaluated.
...
You are not asked to adopt structural realism if you find it unconvincing. The work articulates why structural realism is appropriate here (see [`01-structural-realism.md`](01-structural-realism.md) and [`02-limits-of-falsification.md`](02-limits-of-falsification.md)) and accepts that not every reader will be convinced. A reader who rejects structural realism is invited to consider the work's locally-falsifiable predictions (which do not depend on the structural-realist frame) and form their own judgement about the broader structural claim.
