...
**Assessment for this work.** The cross-domain interfaces in [`../interfaces/`](../interfaces/), together with the two ML-substrate interfaces in the [`mnsm`](https://github.com/qrv0/mnsm) spinoff, document the structural form's appearance in:
...
6. Structured state space models, auxiliary-field equation is mathematically identical, term by term, to the diagonal SSM update. Documented in the [`mnsm`](https://github.com/qrv0/mnsm) spinoff.
